...
<body>
	<div class="container_12">
		...
		<!-- content start -->
			...
			%>
			<form action="qnaedit.korean">
				<input type="hidden" name="qnaNo" value="<%=dto.getQnaNo() %>">
				<table class="table">
					<tr><th>제목</th><td colspan="3"><input type="text" name="title" value="<%=dto.getQnaTitle() %>"/></td>
					<th>작성자</th><td><input type="text" name="name" value="<%=dto.getQnaName() %>" readonly="readonly"></td></tr>
					<tr><th colspan="6">내용</th></tr>
					<tr><td colspan="6"><textarea name="content" id="editor"><%=dto.getQnaContent() %></textarea></td></tr>
				</table>
