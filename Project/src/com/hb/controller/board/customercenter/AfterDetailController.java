...
@WebServlet("/afterdetail.korean")
public class AfterDetailController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("customercenter/afterdetail.jsp").forward(request, response);
	}
